"""
Django settings for winter_cloud_48431 project.
...
ROOT_URLCONF = 'winter_cloud_48431.urls'
...
WSGI_APPLICATION = 'winter_cloud_48431.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Winter Cloud Support <support@winter-cloud-48431.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "winter_cloud_48431 API",
    "DESCRIPTION": "API documentation for winter_cloud_48431 App",
    "VERSION": "v1",
}
